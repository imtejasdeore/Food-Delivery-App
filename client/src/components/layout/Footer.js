        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold">512Bites</span>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed">
              Delicious food delivered fast to your doorstep.
              Fresh ingredients, amazing taste, and unbeatable service from 512Bites.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3 text-sm text-gray-400">
                ...
                <span>+91 7798804542</span>
              </div>
              <div className="flex items-center space-x-3 text-sm text-gray-400">
                <EnvelopeIcon className="w-4 h-4 flex-shrink-0" />
                <span>support@512bites.com</span>
              </div>
              <div className="flex items-start space-x-3 text-sm text-gray-400">
                <MapPinIcon className="w-4 h-4 flex-shrink-0 mt-0.5" />
                <span>123 Food Street, Delivery City, PUNE 411033</span>
              </div>
              <div className="flex items-center space-x-3 text-sm text-gray-400">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-sm text-gray-400">
              © {currentYear} 512Bites. All rights reserved.
            </div>
